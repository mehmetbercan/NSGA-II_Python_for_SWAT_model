...
#---- Input ---- No space on SWATtxtinoutDirectory (space sometimes causes problems that swat.exe gives error)
...
print "All the generations are finished. Look at OUTPUT.OUT folder for results.";
